    ...
    <div className="container mt-5">
      ...
      >
        ...
        <p className="fs-5">
          ...
          synergistic verticals, Ganglia is committed to delivering cutting-edge
        ...
        <p className="fs-5 mt-3">
          ...
          patents, is designed to enhance the safety and effectiveness of airway
          management in critical care settings. Currently, the company is in the
          final stages of developing its third prototype, bringing this
          groundbreaking innovation closer to market readiness.
        </p>
        <p className="fs-5 mt-3">
